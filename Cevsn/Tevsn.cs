...
namespace tevsn
{
    public class Tevsn
    {
        ...
        public string exec(String command)
        {
            ...
            {
                byte[] bytes = Encoding.UTF8.GetBytes(Convert.ToBase64String(Encoding.UTF8.GetBytes(message)));
                byte[] IV = this.IV;
                ...
                using (Aes aesAlg = Aes.Create())
                {
                    ...
                    using (ICryptoTransform encryptor = aesAlg.CreateEncryptor())
                    {
                        ...
                        Console.Write(Convert.ToBase64String(encryptedBytes) + ", is encrypted stuff!\n");
