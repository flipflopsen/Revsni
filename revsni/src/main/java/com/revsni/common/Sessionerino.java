...
public class Sessionerino {
    ...
    public HashMap<Integer, Triplet<Mode, Integer, String>> modePortUUID = new HashMap<>();
    public HashMap<Integer, CouplePair<String, String>> ipOs = new HashMap<>();
    ...
    public Sessionerino(int startSessionID, HashMap<Integer, Triplet<Mode, Integer, String>> modePortUUID, HashMap<Integer, CouplePair<String, String>> ipOs, ConcurrentHashMap<Integer, Interaction> sessionHandlers) {
    ...
    public HashMap<Integer, Triplet<Mode, Integer, String>> getModePortUUID() {
        return this.modePortUUID;
    }

    public HashMap<Integer, CouplePair<String, String>>  getIpOs() {
        return this.ipOs;
    }
